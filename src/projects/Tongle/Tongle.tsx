import GasTax from './imgs/tongle/gas_tax.jpg'
  ...
  return (
    <><div className="writeup-wrapper">
      ...
      <div className="content">
        ...
        <div className="content">
          <img src="img/tongle/in_context.jpg" className="half-width" />
        </div>
      ...
      <div className="content">
        ...
        <div className='flex-wrapper'>
          <div className="flex-left">
            <img className="img-md" src="img/tongle/pd.png" />
          </div>
      ...
      <div className="content">
        ...
        <div className="half-img content">
          <img src="img/tongle/process_horizontal.jpg" className="half-width" />
        </div>
      ...
      <div className="content">
          ...
          <div className="flex-left">
            <div className="container">
              <a className="text-link" href="https://goo.gl/forms/KRRbCLVDkIRVG4kY2" target="blank">
                <img src="img/tongle/survey.png" className="img-md" />
              </a>
        ...
        <h2>Workshop #2</h2>
        <div className="flex-wrapper">
          <img src="img/tongle/storyboard1.png" className="third" />
          <img src="img/tongle/storyboard2.png" className="third" />
          <img src="img/tongle/storyboard3.png" className="third" />
          <div className="content-exp">
        ...
        <div className="content">
          ...
          <div className="content-exp">
            ...
            <div className="flex-wrapper">
              <div className="flex-padding half-width">
                <img src="img/tongle/p1.png" className="half-width-height" />
              ...
              <div className="flex-padding half-width">
                <img src="img/tongle/p2.png" className="half-width-height" />
            ...
            <div className="flex-wrapper">
              <div className="flex-padding half-width">
                <img src="img/tongle/p3.png" className="half-width-height" />
              ...
              <div className="flex-padding half-width">
                <span className="summary-person">
                  <img src="img/tongle/p4.png" className="half-width-height" />
          ...
          <div className="content">
            ...
            <h3>State Flow</h3>
            <img src="img/tongle/state-flow.png" className="half-width-strong" />
            <div className="content">
              <div className="flex-wrapper">
                <div className="flex-left">
                  <h3>Sitemap</h3>
                  <img src="img/tongle/sitemap.png" className="img-md" />
                </div>
                <div className="flex-right">
                  <h3>Medium Fidelity</h3>
                  <img src="img/tongle/medium-fidelity.png" className="img-md" />
                </div>
              </div>
            </div>
            <div className="content">
              <h3>High Fidelity User Flows</h3>
              <img src="img/tongle/key-flow1.png" className="half-width" />
              <img src="img/tongle/key-flow2.png" className="half-width" />
            </div>
            <div className="content">
              <img src="img/tongle/poster.png" className="half-width-strong" />
            </div>
          </div>
