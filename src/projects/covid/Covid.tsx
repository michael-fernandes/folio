  ...
  return (
    <ContentWrapper>
      ...
      <div className="content">
        <p>
          When the pandemic first started, I was working at IHME creating web tools and other software for disease modeling research. In the early days of the pandemic, one of the first outbreaks happened in Washington state, putting IHME in an excellent place to create COVID forecasts. What unfolded next was perhaps the United State’s (and later globe’s) first collective encounter with a predictive model.  You can see the web tool that I contributed to professionally in the above link below. Aftewards I will revisit the visualiaztions and highlight what we might of changed in hindsight.
        </p>
        ...
        <h1>The Challenge</h1>
        <p>
          Revist the IHME covid web access point and see what factors might have been better controlled for widerspread acceptance.
        </p>
        <h1>Covid Modeling in a time</h1>
        <p>
